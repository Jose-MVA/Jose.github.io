...
<body style="background:#edbad1;">
	<br />
	<div class="container">
		<br />
		<br />
		<br />
		<h3 align="center"><a href="https://www.configuroweb.com/" title="Carro de compras" style="color:black;text-decoration:none;">Tu carro de compras</a></h3><br />
		<br /><br />
		<?php
		...
		?>
				<div class="col-md-4">
					<form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
						<div style="border:1px solid #333; background-color:#fdf9c4; border-radius:5px; padding:16px;" align="center">
							<img src="images/<?php echo $row["image"]; ?>" class="img-responsive" /><br />

							<h4 class="text-white" style="color:black"><?php echo $row["name"]; ?></h4>
